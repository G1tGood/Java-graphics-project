...
public class IntegrationTests {
    ...
    void CameraSphereIntersections() {
        ...
        assertEquals(2, countIntersections(nX,nY,new Sphere(new Point(0,0,-3), 1),camera),
        ...
        assertEquals(18, countIntersections(nX,nY,new Sphere(new Point(0,0,-2.5), 2.5),camera),
                "sphere findIntersections and constructRay integration failed: wrong amount of points");

        // TC03: sphere intersects with view plane, r=2 (10 points)
        assertEquals(10, countIntersections(nX,nY,new Sphere(new Point(0,0,-2), 2),camera),
                "sphere findIntersections and constructRay integration failed: wrong amount of points");
        ...
        assertEquals(9, countIntersections(nX,nY,new Sphere(new Point(0,0,-1.5), 4),camera),
                "sphere findIntersections and constructRay integration failed: wrong amount of points");

        // TC05: is behind view plane and camera, r=4 (0 points)
        assertEquals(0, countIntersections(nX,nY,new Sphere(new Point(0,0,1), 0.5),camera),
                "sphere findIntersections and constructRay integration failed: wrong amount of points");
    }
    ...
    void CameraPlaneIntersections() {
        ...
        assertEquals(9, countIntersections(nX,nY,new Plane(new Point(0,0,-1),new Vector(0,0,1)),camera),
        ...
        assertEquals(9, countIntersections(nX,nY,new Plane(new Point(0,0,-1),new Vector(0,-3,6)),camera),
        ...
        assertEquals(6, countIntersections(nX,nY, new Plane(new Point(0,0,-1),new Vector(0,-4,1)),camera),
    ...
    void CameraTriangleIntersections() {
        ...
        assertEquals(1, countIntersections(nX,nY,new Triangle(new Point(0,1,-2), new Point(1,-1,-2), new Point(-1,-1,-2)), camera),"triangle findIntersections and constructRay integration failed: wrong amount of points");

        //TC02 - triangle in front of the view plane (2 points)
        assertEquals(2, countIntersections(nX,nY,new Triangle(new Point(0,20,-2), new Point(1,-1,-2), new Point(-1,-1,-2)), camera),"triangle findIntersections and constructRay integration failed: wrong amount of points");
    }
    ...
    private int countIntersections(int nX, int nY, Intersectable geometry, Camera camera){
        int count = 0;
