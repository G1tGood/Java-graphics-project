...
public class LightsTests {
   ...
   /** Produce a picture of two triangles lighted by a spotlight, a point light and a directional light */
   @Test
   ...
   /** Produce a picture a sphere lighted by a spotlight, a point light and a directional light */
   @Test
   public void sphereALL() {
      scene2.geometries.add(sphere);
      scene2.lights.add(
              new PointLight
                      (new Color(1260,1000,0),
                              new Point(20, 50, 70))
                      .setKl(0.0001)
                      .setKq(0.0005)
      );
